...
parser.add_argument("num_res_arg", help = "This should be the number of reservoirs.", type = str)
...
with open("./target/debug/examples/reservoirs.yaml") as res_file, open("./target/debug/examples/population.yaml") as pop_file:
    ...
    fig.update_layout(title = f"Reservoir and Stream Means. Stream Size={pop_size}, Capacity={capacity}, Number of Reservoirs={num_res}")
    fig.show()
