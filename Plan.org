...
- [ ] 1.0 decision point
  ...
  - [ ] Smart timing adaptor: get desired time interval, time some
    iterations, as long as time is < interval/2,double number of
    iterations being timed. Report time per iterations. Definitely defer to future blog post
